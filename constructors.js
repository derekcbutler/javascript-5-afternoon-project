...
// Code here
User.prototype.removeSavedPost = function(str){
  let unsave = this.savedPosts.findIndex(element => element === str)
  this.savedPosts.splice(unsave, 1)
}
...
User.prototype.changePostRating = function(id, rating) {
  let post = this.savedPosts.find(element => element.id === id)
  post.rating = rating
}
